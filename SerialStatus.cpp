...
void SerialStatus::getCANValue(char lButt, int cButt, bool n, uint16_t H, bool z, uint16_t T1, uint16_t T2, bool repsonse)
{
responseGotten=repsonse;
lastButton=lButt;
counterButton=cButt;
